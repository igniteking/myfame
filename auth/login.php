                    ...
                    <form method="post" action="./login.php">
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="email" id="exampleInputUsername" name="email" class="form-control input-shadow" placeholder="Enter Email">
                        ...
                        <input type="submit" name="login" value="Sign In" class="btn btn-light btn-block"></input>
                    </form>
                </div>
            </div>
