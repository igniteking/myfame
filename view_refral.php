                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $get_requests = mysqli_query($conn, "SELECT * FROM wallet WHERE user_id = '$user_id' AND status = 'bonus' ORDER BY id DESC");
                                                        while ($row = mysqli_fetch_array($get_requests)) {
                                                            ...
                                                            if ($status == 'bonus') {
                                                                $status = '<button class="btn btn-success">bonus</button>';
